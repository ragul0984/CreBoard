...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '166 76 59', // Using brand teal HSL
  ...
  return (
    <div
      ...
      className={`relative grid isolate border border-zinc-200 dark:border-white/15 ${className}`}
      style={{
    ...
    >
      ...
      <div className="flex flex-col h-full relative overflow-hidden z-[1]">
        {children}
      </div>
    </div>
  );
